...
namespace BlazorMasterPage.Components.Services 
{
    public class BootstrapClassProvider : ClassProvider
    {
        ...
        public override string RadioGroup(bool buttons, Orientation orientation) => buttons ? orientation == Orientation.Horizontal ? "btn-group btn-group-toggle" : "btn-group-vertical btn-group-toggle" : null;
        ...
        public override string RadioInline(bool inline) => inline ? UseCustomInputStyles ? "custom-control-inline" : "form-check-inline" : null;
        ...
        public override string LabelType(LabelType labelType)
        {
            switch (labelType)
            {
                case BlazorMasterPage.Components.LabelType.Check:
                case BlazorMasterPage.Components.LabelType.Radio:
                case BlazorMasterPage.Components.LabelType.Switch:
                    return UseCustomInputStyles ? "custom-control-label" : "form-check-label";
                case BlazorMasterPage.Components.LabelType.File:
                    return UseCustomInputStyles ? "custom-file-label" : null;
                case BlazorMasterPage.Components.LabelType.None:
                default:
                    return null;
            }
        }
        ...
        public override string ButtonOutline(Color color) => color != BlazorMasterPage.Components.Color.None ? $"{Button()}-outline-{ToColor(color)}" : $"{Button()}-outline";
        ...
        public override string DropdownToggleOutline(Color color) => color != BlazorMasterPage.Components.Color.None ? $"{Button()}-outline-{ToColor(color)}" : $"{Button()}-outline";
        ...
        public override string BarItem(BarMode mode) => mode == BlazorMasterPage.Components.BarMode.Horizontal ? "nav-item" : "b-bar-item";
        ...
        public override string BarLink(BarMode mode) => mode == BlazorMasterPage.Components.BarMode.Horizontal ? "nav-link" : "b-bar-link";

        public override string BarLinkDisabled(BarMode mode) => Disabled();

        public override string BarBrand(BarMode mode) => mode == BlazorMasterPage.Components.BarMode.Horizontal ? "navbar-brand" : "b-bar-brand";

        public override string BarToggler(BarMode mode, BarTogglerMode togglerMode) => mode == BlazorMasterPage.Components.BarMode.Horizontal ? "navbar-toggler" :
            togglerMode == BarTogglerMode.Popout ? "b-bar-toggler-popout" : "b-bar-toggler-inline";

        public override string BarTogglerCollapsed(BarMode mode, BarTogglerMode togglerMode, bool isShow) => isShow || mode != BlazorMasterPage.Components.BarMode.Horizontal ? null : "collapsed";

        public override string BarMenu(BarMode mode) => mode == BlazorMasterPage.Components.BarMode.Horizontal ? "collapse navbar-collapse" : "b-bar-menu";

        public override string BarMenuShow(BarMode mode) => Show();

        public override string BarStart(BarMode mode) => mode == BlazorMasterPage.Components.BarMode.Horizontal ? "navbar-nav mr-auto" : "b-bar-start";

        public override string BarEnd(BarMode mode) => mode == BlazorMasterPage.Components.BarMode.Horizontal ? "navbar-nav ml-auto" : "b-bar-end";

        public override string BarDropdown(BarMode mode) => mode == BlazorMasterPage.Components.BarMode.Horizontal ? "dropdown" : "b-bar-dropdown";

        public override string BarDropdownShow(BarMode mode) => Show();

        public override string BarDropdownToggle(BarMode mode) => mode == BlazorMasterPage.Components.BarMode.Horizontal ? "nav-link dropdown-toggle" : "b-bar-link b-bar-dropdown-toggle";

        public override string BarDropdownItem(BarMode mode) => mode == BlazorMasterPage.Components.BarMode.Horizontal ? "dropdown-item" : "b-bar-dropdown-item";

        public override string BarTogglerIcon(BarMode mode) => "navbar-toggler-icon";

        public override string BarDropdownMenu(BarMode mode) => mode == BlazorMasterPage.Components.BarMode.Horizontal ? "dropdown-menu" : "b-bar-dropdown-menu";

        public override string BarDropdownMenuVisible(BarMode mode, bool visible) => visible ? Show() : null;

        public override string BarDropdownMenuRight(BarMode mode) => mode == BlazorMasterPage.Components.BarMode.Horizontal ? "dropdown-menu-right" : "b-bar-right";

        public override string BarDropdownMenuContainer(BarMode mode) => mode == BlazorMasterPage.Components.BarMode.Horizontal ? null : "b-bar-dropdown-menu-container";
        ...
        public override string Column(ColumnWidth columnWidth, Breakpoint breakpoint, bool offset)
        {
            ...
            if (breakpoint != BlazorMasterPage.Components.Breakpoint.None && breakpoint != BlazorMasterPage.Components.Breakpoint.Mobile)
            {
        ...
        {
            var baseClass = breakpoint != Breakpoint.None && breakpoint != BlazorMasterPage.Components.Breakpoint.Mobile
        ...
        {
            if (breakpoint != BlazorMasterPage.Components.Breakpoint.None && breakpoint != Breakpoint.Mobile)
